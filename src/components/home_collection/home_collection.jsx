...
function home_collection() {
  return (
         ...
         <div className='h-1/2 bg-blue-50 flex flex-col items-center pt-12 gap-6'>
            
            <Navbar/>
        <div className='flex flex-col gap-6 items-center font-serif text-3xl text-slate-950'>
